module.exports = function (md) {
  ...
  md.renderer.rules.fence = function (tokens, idx, options) {
    ...
    const btnHtml =
      ...
      '<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"><path fill="currentColor" d="M18.9 8.1L9 18l-4.95-4.95l.71-.71L9 16.59l9.19-9.2l.71.71Z"/></svg>' +
      '</button>'
